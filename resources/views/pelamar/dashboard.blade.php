...
@php
    ...
    // Progress kelengkapan profil sederhana
    $fields = ['alamat', 'telepon', 'cv_path', 'tentang'];
    $filled = 0;
    foreach ($fields as $f) {
        if (!empty(optional($pel)->{$f})) {
            $filled++;
        }
    }
    $progress = count($fields) ? round(($filled / count($fields)) * 100) : 0;
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-12">
                    <div class="emp_dashboard_sidebar jb_cover">
                        ...
                        <div class="emp_web_profile candidate_web_profile jb_cover">
                            ...
                            <div class="skills jb_cover">
                                <div class="skill-item jb_cover">
                                    <h6>Profile <span>{{ $progress }}%</span></h6>
                                    <div class="skills-progress"><span style="width: {{ $progress }}%"></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mt-3 d-grid gap-2">
                                <a href="{{ route('pelamar.profil.edit') }}"
                                    class="btn btn-outline-primary btn-sm w-100">Lengkapi Profil</a>
                                <a href="{{ route('jobs.index') }}" class="btn btn-outline-secondary btn-sm w-100">Cari
                                    Lowongan</a>
                            </div>
                        </div>
                        ...
                        <div class="emp_follow_link jb_cover mt-3">
                            <ul class="feedlist">
                                <li><a href="{{ route('pelamar.dashboard') }}" class="link_active"><i
                                            class="fas fa-tachometer-alt"></i> Dashboard</a></li>
                                <li><a href="{{ route('pelamar.profil.edit') }}"><i class="fas fa-edit"></i> Edit
                                        Profil</a></li>
                                <li><a href="{{ route('jobs.index') }}"><i class="fas fa-search"></i> Cari Lowongan</a>
                                </li>
                            </ul>
                ...
                <div class="col-lg-9 col-md-12">
                    <div class="row">
                        <!-- Baris 1: kartu profil ringkas + statistik -->
                        <div class="col-12">
                            <div class="job_listing_left_fullwidth jb_cover">
                                <div class="row align-items-center">
                                    <div class="col-lg-8 col-md-7 col-sm-12">
                                        <div class="d-flex align-items-center gap-3">
                                            <img src="{{ $avatar }}" alt="mini"
                                    ...
                                    <div class="col-lg-4 col-md-5 col-sm-12">
                                        <div class="jp_job_post_right_btn_wrapper jb_cover text-md-end mt-3 mt-md-0">
                        ...
                        <!-- Baris 2: Info dasar + Rekomendasi + Lamaran terakhir -->
                            ...
                            <div class="job_filter_category_sidebar jb_cover">
                                ...
                                <div class="job_overview_header jb_cover">
                                    <div class="jp_listing_overview_list_main_wrapper jb_cover">
                                        <div class="jp_listing_list_icon"><i class="fas fa-phone"></i></div>
                                    ...
                                    <div class="jp_listing_overview_list_main_wrapper jb_cover">
                                        <div class="jp_listing_list_icon"><i class="fas fa-envelope"></i></div>
                                        <div class="jp_listing_list_icon_cont_wrapper">
                                            <ul>
                                                <li>Email:</li>
                                    ...
                                    <div class="jp_listing_overview_list_main_wrapper jb_cover">
                                        <div class="jp_listing_list_icon"><i class="flaticon-location-pointer"></i>
                                        </div>
                                        <div class="jp_listing_list_icon_cont_wrapper">
                                            <ul>
                                                <li>Alamat:</li>
                                    ...
                                    <div class="jp_listing_overview_list_main_wrapper jb_cover">
                                        <div class="jp_listing_list_icon"><i class="fas fa-file-alt"></i></div>
                                        <div class="jp_listing_list_icon_cont_wrapper">
                                            <ul>
                                                <li>CV:</li>
                                                <li>
                                                    @if (!empty($pel?->cv_path))
                                                        <a href="{{ asset('storage/' . $pel->cv_path) }}"
                        ...
                        <div class="col-lg-7 col-md-12">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                @empty
                                                    <tr>
                                                        <td colspan="3" class="text-center text-muted p-4">Kamu
                                                            belum melamar pekerjaan.</td>
                                                    </tr>
                                                @endforelse
                                            </tbody>
                                        </table>
                            ...
                            <div class="job_filter_category_sidebar jb_cover mt-3">
                                <div class="job_filter_sidebar_heading jb_cover">
                                    <h1>Rekomendasi Terbaru</h1>
                                </div>
                                <div class="job_overview_header jb_cover">
                                    <ul class="list-group list-group-flush">
                                        @forelse($rekomendasi as $l)
                                        ...
                                        @empty
                                            <li class="list-group-item text-muted">Belum ada rekomendasi.</li>
                                        @endforelse
                                    </ul>
                                </div>
                            </div>
