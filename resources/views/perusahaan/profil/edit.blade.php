            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-8">
                        ...
                        <div class="small text-white-50">{{ $p?->nama_perusahaan ?? auth()->user()->name }}</div>
                    </div>
                    <div class="col-lg-4">
            ...
            <div class="row g-3">
                ...
                <div class="col-lg-4">
                    <div class="jb-card p-3">
                        ...
                        <div class="mt-2 fw-bold">{{ $p?->nama_perusahaan ?? 'Nama Perusahaan' }}</div>
                        <div class="small text-muted">{{ $p?->kota ? $p->kota . ', ' . $p->provinsi : '' }}</div>
                        @if ($banner)
                            <hr>
                            ...
                            <form method="POST" action="{{ route('perusahaan.profil.update') }}"
                                ...
                                <div class="col-md-8">
                                    ...
                                    <input name="nama_perusahaan"
                                        ...
                                        value="{{ old('nama_perusahaan', $p?->nama_perusahaan) }}" required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input name="website" type="url"
                                        ...
                                        placeholder="https://example.com" value="{{ old('website', $p?->website) }}">
                                    @error('website')
                                        <div class="text-danger small">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input name="kota" class="form-control @error('kota') is-invalid @enderror"
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input name="provinsi" class="form-control @error('provinsi') is-invalid @enderror"
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input name="kode_pos" class="form-control @error('kode_pos') is-invalid @enderror"
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input name="facebook" type="url"
                                        ...
                                        placeholder="https://facebook.com/…" value="{{ old('facebook', $p?->facebook) }}">
                                    @error('facebook')
                                        <div class="text-danger small">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input id="logoInput" type="file" name="logo" accept=".jpg,.jpeg,.png,.webp"
                                        class="d-none">
                                    @error('logo')
                                        <div class="text-danger small">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input id="bannerInput" type="file" name="banner" accept=".jpg,.jpeg,.png,.webp"
                                        class="d-none">
                                    @error('banner')
                                        <div class="text-danger small">{{ $message }}</div>
                                    @enderror
...
@push('scripts')
    <script>
        ...
        bannerInput?.addEventListener('change', e => {
            const f = e.target.files?.[0];
            if (!f) return;
            if (bannerPrev) bannerPrev.src = URL.createObjectURL(f);
            else {
